...
motherboards_category = Category.create(name_en: 'Motherboards')
ram_category = Category.create(name_en: 'RAM')
hdd_category = Category.create(name_en: 'HDDs')

fixtures_category = Category.create(name_en: 'Fixtures')
